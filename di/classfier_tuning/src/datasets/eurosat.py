...
class EuroSAT:
    def __init__(self,
        ...
        self.classnames = ['Annual Crop Land', 'Forest', 'Herbaceous Vegetation Land', 
                           'Highway or Road', 'Industrial Building', 'Pasture Land', 
                           'Permanent Crop Land', 'Residential Building', 'River', 'Sea or Lake']
...
class EuroSATrain(EuroSAT):

    def get_test_dataset(self):
        pass

class EuroSATK(EuroSAT):
...
class EuroSATSubsample(EuroSAT):
...
class EuroSATSubsampleValClasses(EuroSAT):
    def get_class_sublist_and_mask(self):
        raise NotImplementedError()
