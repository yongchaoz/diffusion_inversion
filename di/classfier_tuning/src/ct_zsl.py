...
import sys
sys.path.append(
    '/h/zycluke/Project/diffusion_g/src/SyntheticData/src/classifier-tuning')

from src.models.finetune import finetune_zsl
...
def classifier_tuning(args):
    ...
    finetuned_checkpoint = finetune_zsl(args, train_data_aug)
