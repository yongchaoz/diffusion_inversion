...
def parse_arguments():
    ...
    parser.add_argument('--data_aug_lp', action='store_true',
                        help='train data aug for linear probe, not feature datasets')
    parser.add_argument('--hard_pseudo_label', action='store_true',
                        help='train data aug for linear probe, not feature datasets')
    ...
    #     "--ds-real",
    #     default=None,
    #     help="real data dataset to train on",
    # )
    # parser.add_argument(
    #     "--ds-syn",
    #     default=None,
    #     help="syn data dataset to train on",
    # )
    parser.add_argument(
        "--template",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Loss weight balancing real and syn loss."
    )
    parser.add_argument(
        "--loss-weight-real",
        type=float,
